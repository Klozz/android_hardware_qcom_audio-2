...
LOCAL_C_INCLUDES += $(TARGET_OUT_INTERMEDIATES)/kernel/msm-4.14/usr/include
LOCAL_C_INCLUDES += $(TARGET_OUT_INTERMEDIATES)/kernel/msm-4.14/usr/include/audio
LOCAL_C_INCLUDES += $(TARGET_OUT_INTERMEDIATES)/kernel/msm-4.14/usr/audio/include
LOCAL_C_INCLUDES += $(TARGET_OUT_INTERMEDIATES)/kernel/msm-4.14/usr/audio/include/uapi
